...
//   return (
//     <div className="page-container" style={{ padding: '40px 28px', maxWidth: '820px', margin: '0 auto' }}>

//       <div style={{ marginBottom: '32px' }}>
//         <h2 className="section-title">Network Topology</h2>
//         <p className="section-sub" style={{ marginTop: '6px' }}>
//           Configure the underlying Mininet SDN structure. Deploying a new topology restarts
//           both Mininet and the Ryu controller.
//         </p>
//       </div>

//       <TopologySelector topologyType={topologyType} setTopologyType={setTopologyType} />

//       <div className="warn-box" style={{ marginTop: '28px' }}>
//         <strong>Warning:</strong> Confirming will modify <code>network_topology.py</code> on
//         the server and clear the existing Mininet environment (removes veth interfaces and OVS
//         bridges) before relaunching automatically. This process may take 10–20 seconds.
//       </div>
//     </div>
//   );
// };
